    ...
    private void clickListenHandler(){
        ...
        populate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Vehicle v1 = new Vehicle(273,6500,5,6497,"nissan","altima",2023,"sedan",true,"https://65e81151f52e248c552b-fe74cd567ea2f1228f846834bd67571e.ssl.cf1.rackcdn.com/ldm-images/2020-Nissan-Altima-Color-Super-Black.png");
                Vehicle v2 = new Vehicle(285,5400,5,4578,"toyota","avalon",2023,"sedan",true,"https://img.sm360.ca/ir/w640h390c/images/newcar/ca/2020/toyota/avalon/limited/sedan/main/2020_toyota_avalon_LTD_Main.png");
                Vehicle v3 = new Vehicle(287,5000,5,1379,"subaru","wrx",2023,"sedan",true,"https://img.sm360.ca/ir/w640h390c/images/newcar/ca/2020/subaru/wrx/base-wrx/sedan/exteriorColors/12750_cc0640_001_d4s.png");

                Vehicle v4 = new Vehicle(265,5000,5,6490,"kia","telluride",2023,"suv",true,"https://www.cstatic-images.com/car-pictures/xl/usd00kis061c021003.png");
                Vehicle v5 = new Vehicle(229,6000,5,4970,"lincoln","aviator",2023,"suv",true,"https://www.cstatic-images.com/car-pictures/xl/usd00lis021b021003.png");
                Vehicle v6 = new Vehicle(219,3000,5,595,"ford","explorer",2023,"suv",true,"https://www.cstatic-images.com/car-pictures/xl/usd00fos102d021003.png");

                Vehicle v7 = new Vehicle(297,5600,2,200,"chevrolet","camaro",2023,"coupe",false,"https://www.cstatic-images.com/car-pictures/xl/usc90chc022b021003.png");
                ...
                Insurance i2 = new Insurance("Basic",2000);
                Insurance i3 = new Insurance("Premium",2500);
